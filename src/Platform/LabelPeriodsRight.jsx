...
export default function PeriodsRight({ labelThickness, radius, height, fontSizeBraille, colors, fontSize }) {
    ...
    return <>
        <mesh
            ...
            position={[20.7, labelThickness / 2, 3.85]}
            material={colors[5]}
            castShadow
        >
            <BoxBlendGeometry width={0.5} height={6.5} depth={labelThickness} radius={radius} />
